...
public class PersonUt {
   ...
   [Fact]
   public void PersonSetUserUt() {
      // Arrange
      // Act
      _seed.Person1.SetUser(_seed.User1);
      // Assert
      Assert.NotNull(_seed.Person1.User);
      Assert.Equivalent(_seed.Person1.User,_seed.User1);
   }
   
   [Fact]
   public void PersonSetUserToNullUt() {
      // Arrange
      _seed.Person1.SetUser(_seed.User1);
      // Act
      _seed.Person1.SetUser(null);
      // Assert
      Assert.Null(_seed.Person1.User);
   }
